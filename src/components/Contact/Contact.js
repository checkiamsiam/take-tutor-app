...
const Contact = () => {
  return (
    <div>
      <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 container mx-auto">
        <div className="container mx-auto">
          <div className="flex flex-wrap lg:justify-between -mx-4">
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 lg:mb-0  mx-5">
                ...
                <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      Kajirgaon , Chadnimath , Jatrabari , Dhaka , Bangladesh
                    </p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">(+88) 0190 0072 661</p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">issheikh02415@yahoo.com</p>
                  </div>
                </div>
              </div>
            </div>
